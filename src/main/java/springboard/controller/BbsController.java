...
public class BbsController {
	...
	@Autowired
		...
		싶을 때 사용한다. 타입을 기반으로 자동주입되며, 만약 해당
		타입의 빈이 존재하지 않으면 에러가 발생되어 서버를 시작할 수 없다.
	...
	해당 빈은 스프링컨테이너가 시작될 때 생성되며, 타입을 기반으로
	자동 주입 받게된다.
	 */
	@Autowired
	...
	//전송방식 post이므로 value, method 까지 같이 기술해서 매핑
